...
for (int _i = 0; _i < _n; _i++) {
    ...
    [&]() { for (int _i = 0; _i < (int)[&]() { auto _r = vector<decay_t<decltype([&](auto _it) { return answers[_it]; }([&]() { vector<int> _r; for (auto _i = 1; _i < n; _i++) _r.push_back(_i); return _r; }().front()))>>(); _r.reserve([&]() { vector<int> _r; for (auto _i = 1; _i < n; _i++) _r.push_back(_i); return _r; }().size()); for (auto& _it : [&]() { vector<int> _r; for (auto _i = 1; _i < n; _i++) _r.push_back(_i); return _r; }()) _r.push_back([&](auto _it) { return answers[_it]; }(_it)); return _r; }().size(); _i++) { if (_i) cout << " "; cout << [&]() { auto _r = vector<decay_t<decltype([&](auto _it) { return answers[_it]; }([&]() { vector<int> _r; for (auto _i = 1; _i < n; _i++) _r.push_back(_i); return _r; }().front()))>>(); _r.reserve([&]() { vector<int> _r; for (auto _i = 1; _i < n; _i++) _r.push_back(_i); return _r; }().size()); for (auto& _it : [&]() { vector<int> _r; for (auto _i = 1; _i < n; _i++) _r.push_back(_i); return _r; }()) _r.push_back([&](auto _it) { return answers[_it]; }(_it)); return _r; }()[_i]; } cout << '\n'; }();
} }();
    return 0;
}
